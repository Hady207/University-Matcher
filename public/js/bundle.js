...
},{}],"campus.js":[function(require,module,exports) {
"use strict";
...
var commentDeleteBtn = document.querySelector('.comment-delete'); // DELEGATION
...
if (deleteBtn) deleteBtn.addEventListener('click', function (e) {
  ...
  var reviewid = deleteBtn.getAttribute('data-reviewid'); // console.log(uniid, reviewid);
...
if (commentForm) {
  ...
  commentForm.forEach(function (form, i) {
    form.addEventListener('submit', function (e) {
      ...
      console.log("".concat(comment), form.dataset.unique);
