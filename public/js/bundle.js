...
},{"./lib/axios":"../../node_modules/axios/lib/axios.js"}],"UI/alerts.js":[function(require,module,exports) {
"use strict";
...
},{}],"Forms/login.js":[function(require,module,exports) {
"use strict";
...
},{"axios":"../../node_modules/axios/index.js","../UI/alerts":"UI/alerts.js"}],"Forms/reviewForm.js":[function(require,module,exports) {
"use strict";
...
function () {
  var _ref = _asyncToGenerator(
  /*#__PURE__*/
  regeneratorRuntime.mark(function _callee(id, review, rating) {
    var res;
    return regeneratorRuntime.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 3:
            res = _context.sent;
            (0, _alerts.showAlert)('success', 'Thanks for your input');
          ...
          case 8:
            ...
            (0, _alerts.showAlert)('error', 'Please Give the review a rating');
...
function () {
  var _ref2 = _asyncToGenerator(
  /*#__PURE__*/
  regeneratorRuntime.mark(function _callee2(uniId, reviewId) {
    var res;
    return regeneratorRuntime.wrap(function _callee2$(_context2) {
      while (1) {
        switch (_context2.prev = _context2.next) {
          ...
          case 8:
            ...
            (0, _alerts.showAlert)('error', 'You Cant delete This review');
...
},{"axios":"../../node_modules/axios/index.js","../UI/alerts":"UI/alerts.js"}],"Forms/updateSettings.js":[function(require,module,exports) {
"use strict";
...
exports.likeClicked = exports.deleteComment = exports.sendComment = exports.sendPost = void 0;
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 3:
            ...
            if (res.data.status === 'success') {
              location.reload(true);
              (0, _alerts.showAlert)('success', 'complete');
            }
          ...
          case 7:
            _context.prev = 7;
            _context.t0 = _context["catch"](0);
            (0, _alerts.showAlert)('error', 'faild');
...
function () {
  var _ref2 = _asyncToGenerator(
  /*#__PURE__*/
  regeneratorRuntime.mark(function _callee2(postId, comment) {
    var res;
    return regeneratorRuntime.wrap(function _callee2$(_context2) {
      while (1) {
        switch (_context2.prev = _context2.next) {
          ...
          case 3:
            res = _context2.sent;
            location.reload(true);
            (0, _alerts.showAlert)('success', 'Comment Posted');
            _context2.next = 11;
            break;
  ...
  return function sendComment(_x2, _x3) {
    return _ref2.apply(this, arguments);
  };
}();
...
function () {
  var _ref3 = _asyncToGenerator(
  /*#__PURE__*/
  regeneratorRuntime.mark(function _callee3(postId, commentId) {
    var res;
    return regeneratorRuntime.wrap(function _callee3$(_context3) {
      while (1) {
        switch (_context3.prev = _context3.next) {
          ...
          case 3:
            res = _context3.sent;
            location.reload(true);
            (0, _alerts.showAlert)('success', 'comment Deleted');
            _context3.next = 11;
            break;
          ...
          case 8:
            _context3.prev = 8;
            _context3.t0 = _context3["catch"](0);
            (0, _alerts.showAlert)('error', 'Your are not allowed to delete the message');
  ...
  return function deleteComment(_x4, _x5) {
    return _ref3.apply(this, arguments);
  };
}();
...
var likeClicked = function likeClicked(data) {};

exports.likeClicked = likeClicked;
},{"axios":"../../node_modules/axios/index.js","../UI/alerts":"UI/alerts.js"}],"Forms/adminCRUD.js":[function(require,module,exports) {
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.deleteAdminUser = exports.deleteAdminReview = exports.deleteAdminUniversity = exports.editAdminUniversity = void 0;
...
// Edit University
var editAdminUniversity =
/*#__PURE__*/
function () {
  var _ref = _asyncToGenerator(
  /*#__PURE__*/
  regeneratorRuntime.mark(function _callee(id, data) {
    return regeneratorRuntime.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
  ...
  return function editAdminUniversity(_x, _x2) {
    return _ref.apply(this, arguments);
  };
}(); // Delete University


exports.editAdminUniversity = editAdminUniversity;

var deleteAdminUniversity =
/*#__PURE__*/
function () {
  var _ref2 = _asyncToGenerator(
  /*#__PURE__*/
  ...
  return function deleteAdminUniversity(_x3) {
    return _ref2.apply(this, arguments);
  };
}(); // Delete Review


exports.deleteAdminUniversity = deleteAdminUniversity;

var deleteAdminReview =
/*#__PURE__*/
function () {
  var _ref3 = _asyncToGenerator(
  /*#__PURE__*/
  ...
  return function deleteAdminReview(_x4) {
    return _ref3.apply(this, arguments);
  };
}(); // Delete User
...
function () {
  ...
  return function deleteAdminUser(_x5) {
    return _ref4.apply(this, arguments);
  };
}();

exports.deleteAdminUser = deleteAdminUser;
},{"axios":"../../node_modules/axios/index.js"}],"Forms/uniDash.js":[function(require,module,exports) {
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.renderUni = void 0;
...
function () {
        ...
        switch (_context.prev = _context.next) {
          ...
          case 3:
            ...
            if (res.data.status === 'added') {
              (0, _alerts.showAlert)('success', 'added to favorite');
            } else {
              (0, _alerts.showAlert)('success', 'removed from favorite');
            }
  ...
  return function favorite(_x) {
    return _ref.apply(this, arguments);
  };
}();

exports.favorite = favorite;
},{"axios":"../../node_modules/axios/index.js","../UI/alerts":"UI/alerts.js"}],"Forms/likes.js":[function(require,module,exports) {
"use strict";
...
function () {
  ...
  return function dislike(_x2) {
    return _ref2.apply(this, arguments);
  };
}();

exports.dislike = dislike;
},{"axios":"../../node_modules/axios/index.js","../UI/alerts":"UI/alerts.js"}],"Forms/followers.js":[function(require,module,exports) {
"use strict";
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 3:
            ...
            if (res.data.status === 'success') {
              (0, _alerts.showAlert)('success', 'followed');
              location.reload(true);
            }
...
function () {
      ...
      while (1) {
        switch (_context2.prev = _context2.next) {
          ...
          case 3:
            ...
            if (res.data.status === 'success') {
              (0, _alerts.showAlert)('success', 'unfollowed');
              location.reload(true);
            }
  ...
  return function unFollow(_x2) {
    return _ref2.apply(this, arguments);
  };
}();

exports.unFollow = unFollow;
},{"axios":"../../node_modules/axios/index.js","../UI/alerts":"UI/alerts.js"}],"UI/mapbox.js":[function(require,module,exports) {
"use strict";
...
var displayMap = function displayMap(place) {
  mapboxgl.accessToken = 'pk.eyJ1IjoidW5pdmVyc2l0eW1hdGNoZXIiLCJhIjoiY2syZGMyb3llMGU3cjNvcWI4ZXBtenF5NCJ9.l9S9ooBj7yen7PFIlZwddA';
  ...
  var bound = new mapboxgl.LngLatBounds(); //Creat marker
  ...
  new mapboxgl.Marker({
    element: el,
    anchor: 'bottom'
  }).setLngLat(place.coordinates).addTo(map); // Add popup

  new mapboxgl.Popup({
    offset: 30
  }).setLngLat(place.coordinates).setHTML("<p>Address ".concat(place.address, ": ").concat(place.description, "</p>")).addTo(map); //   Extend map bounds to include current location
...
var _reviewForm = require("./Forms/reviewForm");

var _updateSettings = require("./Forms/updateSettings");

var _campus = require("./Forms/campus");

var _adminCRUD = require("./Forms/adminCRUD");

var _uniDash = require("./Forms/uniDash");

var _favoriteButton = require("./Forms/favoriteButton");

var _likes = require("./Forms/likes");

var _followers = require("./Forms/followers");

var _mapbox = require("./UI/mapbox");
...
var postForm = document.querySelector('#campusPost');
var commentForm = document.querySelectorAll('#commentPost');
...
if (favoriteBtn) {
  favoriteBtn.addEventListener('click', function (e) {
    var id = favoriteBtn.dataset.universityid;
    (0, _favoriteButton.favorite)(id);
    favoriteBtn.classList.toggle('favoriteButtonActive');
  });
}

if (mapBox) {
  var place = JSON.parse(document.getElementById('map').dataset.location);
...
if (commentForm) {
  commentForm.forEach(function (form, i) {
    form.addEventListener('submit', function (e) {
      e.preventDefault();
      var comment = document.querySelector("#commentText-".concat(i)).value;
      (0, _campus.sendComment)(form.dataset.unique, comment);
    });
  });
}
...
if (commentDeleteBtn) {
  commentDeleteBtn.addEventListener('click', function (e) {
    ...
    (0, _campus.deleteComment)(postId, commentId);
  });
}
...
if (likeButton) {
  likeButton.forEach(function (button, i) {
    button.addEventListener('click', function (e) {
      ...
      var id = button.dataset.likeid;
      var dislikeButton2 = document.querySelector("#dislikeButton-".concat(i));
...
if (dislikeButton) {
  dislikeButton.forEach(function (button, i) {
    button.addEventListener('click', function (e) {
      button.style.display = 'none';
      var id = button.dataset.unlikeid;
      var likeButton2 = document.querySelector("#likeButton-".concat(i));
...
if (followButton) {
  followButton.addEventListener('click', function (e) {
    var id = followButton.dataset.friend;
    (0, _followers.follow)(id);
  });
}

if (unfollowButton) {
  unfollowButton.addEventListener('click', function (e) {
    var id = unfollowButton.dataset.friend;
    (0, _followers.unFollow)(id);
  });
}

if (unfollowList) {
  unfollowList.forEach(function (unfollowed, i) {
    unfollowed.addEventListener('click', function (e) {
      var id = unfollowed.dataset.idfollower;
      (0, _followers.unFollow)(id);
